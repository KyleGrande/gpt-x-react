...
const LoginForm = ({ onLogin }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const cognitoUserId = userPool.getCurrentUser().getUsername(); // Get the Cognito user ID
      onLogin(idToken, accessToken, cognitoUserId); // Pass the Cognito user ID to the callback
    } catch (error) {
